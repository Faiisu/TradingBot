...
- [x] MT5 terminal reports an unlimited (or ≥ 10M) max-bars setting before fetching
- [x] Cached H1, M30, M15 and M5 gold history each cover ~728 days; the coverage report shows no shortfall warning for any of them
- [x] The Backtest runs on the common window, which now starts around 2024-09 instead of 2025-04
- [x] The Backtest page's run info shows the new data window
